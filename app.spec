...
rsync -a --exclude ".git" --exclude "rpm" --exclude build_tools --exclude Makefile --exclude app.spec --exclude ".gitignore" --exclude "blackcatmq.service" --exclude "*.log" %{abs_top_builddir}/ $RPM_BUILD_ROOT%{prefix}/%{name}
